...
#pragma pack(pop)
    ...
    const native_pixel_format pf_uyvyl      = { 'UYVY', 1, 2,{  { true,  &unpack_uyvy<RS2_FORMAT_RGB8 >,                 { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_RGB8 } } },
                                                                { true,  &unpack_yuy2<RS2_FORMAT_Y16>,                   { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_Y16 } } },
                                                                { false, &copy_pixels<2>,                                { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_UYVY } } },
                                                                { true,  &unpack_uyvy<RS2_FORMAT_RGBA8>,                 { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_RGBA8} } },
                                                                { true,  &unpack_uyvy<RS2_FORMAT_BGR8 >,                 { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_BGR8 } } },
                                                                { true,  &unpack_uyvy<RS2_FORMAT_BGRA8>,                 { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_BGRA8} } } } };

    const native_pixel_format pf_rgb888     = { 'RGB2', 1, 2,{  { true,  &unpack_rgb_from_bgr,                           { { { RS2_STREAM_INFRARED, 1}, RS2_FORMAT_RGB8 } } } } };
